...
The list includes both free APIs, and those which you have to pay to use - 💰
 ...
 - 💰 [Live Tennis API](https://livetennisapi.com/) - WebSocket push feed for live tennis across ATP, WTA, Challenger and ITF: every point as it happens, with the scoreline, who is serving and match events. Speaks the Centrifugo client protocol rather than plain JSON frames. Streaming is a paid tier; the REST live-score endpoint has a free tier (100 calls/day, no card).
